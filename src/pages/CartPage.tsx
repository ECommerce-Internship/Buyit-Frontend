    ...
    if (isEmpty) {
        return (
            <div className="min-h-screen bg-[linear-gradient(180deg,#f7f6fb_0%,#fff7f2_100%)] flex items-center justify-center px-4">
                <div className="max-w-md text-center bg-white rounded-3xl shadow-sm border border-[#efe8f6] p-10">
                    <div className="mx-auto mb-6 flex h-28 w-28 items-center justify-center rounded-full bg-[#fff1ea]">
            ...
            <div className="px-4 py-10">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_340px] items-start">
                        <div className="rounded-2xl border border-[#efe8f6] bg-white shadow-sm">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex min-w-0 items-center gap-5">
                                                <div className="h-24 w-24 shrink-0 overflow-hidden rounded-xl border border-[#f0edf7] bg-[#faf9fc]">
                                                    {item.imageUrl ? (
                                                        <img
                                                            src={item.imageUrl}
                        ...
                        <div className="space-y-4 self-start lg:sticky lg:top-8">
