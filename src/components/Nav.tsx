      ...
      <div style={{
        ...
        <a href="#top" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          <img
            ...
            alt=""
            aria-hidden
            style={{ height: 34, width: 'auto', display: 'block', filter: 'drop-shadow(0 0 12px rgba(139,92,246,0.5))' }}
          />
          <img src={buyitWordmark} alt="Buyit" style={{ height: 24, width: 'auto', display: 'block' }} />
        </a>
